  ...
  return (
    ...
    >
      ...
      <g id="patientFigure" transform="translate(132, 34)">
        ...
        <path
          d="M23 25C24 24.5 25.5 24.5 26.5 25"
          stroke="#4F46E5"
          strokeWidth="0.9"
          strokeLinecap="round"
        />
        ...
        <path
          d="M24 31C25 32 26.5 32 27.5 31"
          stroke="#4F46E5"
          strokeWidth="0.9"
          strokeLinecap="round"
        />
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#avatarCircle)">
        ...
        <path
          d="M10 18C10 10 13 6 18 6C23 6 26 10 26 18C26 24 24 28 24 28H12C12 28 10 24 10 18Z"
          fill="url(#hairGrad)"
        />

        <path
          d="M6 36C6 29 11 25 18 25C25 25 30 29 30 36H6Z"
          fill="#3B82F6"
        />
        ...
        <path
          d="M12.5 14C12.5 10 14.5 8 18 8C21.5 8 23.5 10 23.5 14C23.5 12 22 9.5 18 9.5C14 9.5 12.5 12 12.5 14Z"
          fill="url(#hairGrad)"
        />

        <path
          d="M12.5 13C13 16 14 18 14 18C13 16 12.5 14.5 12.5 13Z"
          fill="url(#hairGrad)"
        />

        <path
          d="M23.5 13C23 16 22 18 22 18C23 16 23.5 14.5 23.5 13Z"
          fill="url(#hairGrad)"
        />

        <path
          d="M14.5 14C15 13.5 16 13.5 16.5 14"
          stroke="#1E293B"
          strokeWidth="0.8"
          strokeLinecap="round"
        />
        ...
        <path
          d="M19.5 14C20 13.5 21 13.5 21.5 14"
          stroke="#1E293B"
          strokeWidth="0.8"
          strokeLinecap="round"
        />
        ...
        <path
          d="M16.5 19C17 20 19 20 19.5 19"
          stroke="#9A3412"
          strokeWidth="0.9"
          strokeLinecap="round"
        />
            ...
            return (
              <li key={item.id} className="cw-sidebar-nav-item">
                ...
                >
                  ...
                  <span className="cw-sidebar-nav-label">
                    {item.label}
                  </span>
                </button>
              </li>
